...
public class ClientFunctions {
	 ...
	 * 
	 * NOTE: Has to be updated to give a certain message like username in use or
	 * server not connectable
	 * 
	 * @param host
	 * @param userName
	 * @return
	...
	public boolean connect(String host, String userName) {
		...
		// Here check if its possible to create a socket else it will fail and
		// return false
		try {
			createSocket();
	...
	/**
	 * Ask the socket to give us a list of agents that are known to the server.
	 * This could be to hack them or worse..
	 * 
	 * @throws IOException
	 */
